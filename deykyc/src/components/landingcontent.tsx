...
const LandingContent: React.FC = () => {
    return (
      <div className="px-10 pb-20">
        <h2 className="text-center text-4xl font-bold text-black mt-10">How it works</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-10 mt-10">
          {features.map((item, index) => (
            <Card
              key={item.title}
              className={`bg-slate-200 border-none text-black shadow-lg ${
