...
//   const [isMinting, setIsMinting] = useState(true); // Newly added state for minting process
...
//       <div className='min-h-screen overflow-hidden flex md:flex-row justify-center items-center flex-col bg-gradient-to-r from-rose-100 to-teal-100'>
//         <div className='m-24'>
//           <Image className='rounded-md' src={kyc} width={1200} height={1200} alt="Picture of the author" />
//         </div>
...
//       action={(contract) => {
//         contract.call("mint", [1, minting.uri, address, minting.signature])
//       }}
//       onSuccess={()=>mintNFT()}
//     >
//       mint
...
import { getotp, gettokenurl } from '../../../actions/actions';
import { key } from '../info/page';
import { CompilerMetadataFetchedSchema, Web3Button } from "@thirdweb-dev/react";
import { useAddress } from "@thirdweb-dev/react";
import Navbart from "../components/navbar";
